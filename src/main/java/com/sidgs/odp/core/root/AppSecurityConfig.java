...
import com.sidgs.odp.core.security.AjaxAuthenticationSuccessHandler;
import com.sidgs.odp.core.security.SecurityUserDetailsService;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .and()
            .formLogin()
            .defaultSuccessUrl("/resources/success.html")
